...
| [Customer Service Assistant](https://github.com/Handit-AI/handit-demo-customer-service-asssitant) | [Document Classification](https://github.com/Handit-AI/handit-demo-docs-classification) |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| ![Tracing Assistant](apps/dashboard/public/assets/use_cases/tracing_assistant.png)<br>AI conversation monitoring and improvement | ![Complete Flow](apps/dashboard/public/assets/use_cases/complete_flow.png)<br>Document processing with accuracy boost |
